...
class MyAdapter3(private val context: Context, var restaurants: ArrayList<Restaurant>, val listener: DashboardFragment) :
    RecyclerView.Adapter<MyAdapter3.ViewHolder>() {
    ...
    interface OnItemClicked{
        fun onItemClick3(position: Int, restaurant: Restaurant)
    }
