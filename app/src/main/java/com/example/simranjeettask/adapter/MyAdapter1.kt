...
class MyAdapter1(private val context: Context, var restaurants: ArrayList<Restaurant>, val listener: DashboardFragment) :
    ...
    interface OnItemClicked{
        fun onItemClick1(position: Int, restaurant: Restaurant)
    }
